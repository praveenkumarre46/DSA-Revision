<h2><a href="https://leetcode.com/problems/binary-tree-pruning/?envType=problem-list-v2&envId=depth-first-search">832. Binary Tree Pruning</a></h2><h3>Medium</h3><hr><p>Given the <code>root</code> of a binary tree, return <em>the same tree where every subtree (of the given tree) not containing a </em><code>1</code><em> has been removed</em>.</p>
